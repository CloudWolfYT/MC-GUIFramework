...
## if ui is not found
execute if score @s ui.id matches 1.. if score #loop open_ui matches 0 run function a:ui/return/exit_ui
execute if score #loop open_ui matches 0 run scoreboard players set @s ui.id 0
execute if score #loop open_ui matches 0 run scoreboard players set @s open_ui1 0